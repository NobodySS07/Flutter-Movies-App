...
class superMan extends StatefulWidget{
  @override
  _superMan createState() => _superMan();

}
// ignore: camel_case_types
class _superMan extends State<superMan>{

  Map data;
  List userData;

  Future getData() async{
    http.Response response = await http.get("http://omdbapi.com/?s=SuperMan&page=2&apikey=3750dc58");
