...
class hulk extends StatefulWidget{
  @override
  _hulk createState() => _hulk();

}
// ignore: camel_case_types
class _hulk extends State<hulk>{

  Map data;
  List userData;

  Future getData() async{
    http.Response response = await http.get("http://omdbapi.com/?s=hulk&page=2&apikey=3750dc58");
