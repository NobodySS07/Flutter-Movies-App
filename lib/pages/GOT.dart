...
class GOT extends StatefulWidget{
  @override
  _GOT createState() => _GOT();

}
// ignore: camel_case_types
class _GOT extends State<GOT>{

  Map data;
  List userData;

  Future getData() async{
    http.Response response = await http.get("http://www.omdbapi.com/?s=Game%20of%20Thrones&page=2&apikey=3750dc58");
